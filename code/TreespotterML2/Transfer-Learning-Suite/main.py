...
parser.add_argument('--image', type=str, default="/home/jonas/Images/test/Granstam/IMG_0002.jpg", help='The image you want to predict on. Only valid in "predict" mode.')
parser.add_argument('--continue_training', type=str2bool, default=False, help='Whether to continue training from a checkpoint')
#parser.add_argument('--dataset', type=str, default="Trees", help='Dataset you are using.')
...
parser.add_argument('--image_dir', type=str, default="/data/home/jonas/Images/", help='base dir to images')
...
if args.mode == "train":
    ...
    train_generator = train_datagen.flow_from_directory(BASE_IMG_DIR + TRAIN_DIR, target_size=(HEIGHT, WIDTH), batch_size=BATCH_SIZE)

    validation_generator = val_datagen.flow_from_directory(BASE_IMG_DIR + VAL_DIR, target_size=(HEIGHT, WIDTH), batch_size=BATCH_SIZE)
